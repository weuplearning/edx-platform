...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApocScore'
        db.create_table('auth_apocscore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('stage_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('stage_status', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('stage_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('stage_begin', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('stage_last_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('student', ['ApocScore'])


    def backwards(self, orm):
        # Deleting model 'ApocScore'
        db.delete_table('auth_apocscore')
    ...
    models = {
        ...
        'student.apocscore': {
            'Meta': {'object_name': 'ApocScore', 'db_table': "'auth_apocscore'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stage_begin': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'stage_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'stage_last_accessed': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'stage_score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'stage_status': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'student.apocstatus': {
            'Meta': {'object_name': 'ApocStatus', 'db_table': "'auth_apocstatus'"},
        ...
        'student.userprofile': {
            ...
            'amundiid': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
