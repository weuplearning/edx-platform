...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApocStatus'
        db.create_table('auth_apocstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('current_stage', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('student', ['ApocStatus'])


    def backwards(self, orm):
        # Deleting model 'ApocStatus'
        db.delete_table('auth_apocstatus')
