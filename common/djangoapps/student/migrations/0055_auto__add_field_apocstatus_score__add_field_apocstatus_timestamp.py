...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApocStatus.score'
        db.add_column('auth_apocstatus', 'score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApocStatus.timestamp'
        db.add_column('auth_apocstatus', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApocStatus.score'
        db.delete_column('auth_apocstatus', 'score')

        # Deleting field 'ApocStatus.timestamp'
        db.delete_column('auth_apocstatus', 'timestamp')
