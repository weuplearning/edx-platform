...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApocStatus.scorebis'
        db.add_column('auth_apocstatus', 'scorebis',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ApocStatus.scorebis'
        db.delete_column('auth_apocstatus', 'scorebis')
    ...
    models = {
        ...
        'student.apocstatus': {
            ...
            'scorebis': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
