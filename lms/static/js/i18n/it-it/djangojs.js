...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(Self-paced) Starts {start}": "(Self-paced) Inizia {start}",
    "(Staff)": "(Staff)",
    ...
    "Error: User '<%- username %>' has not yet activated their account. Users must create and activate their accounts before they can be assigned a role.": "Errore: l'Utente '<%- nome utente %>' non ha ancora attivato il proprio account. Gli utenti devono creare e attivare i propri account prima che gli possa essere assegnato un ruolo.",
    ...
    "Once your account is deleted, you cannot use it to take courses on the {platformName} app, {siteName}, or any other site hosted by {platformName}.": "Una volta che il tuo account \u00e8 stato eliminato, non puoi utilizzarlo per seguire i corsi sul sito https://acceleraconamazon.it/",
    ...
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "Il campo nome utente/email dello studente \u00e8 obbligatorio e non pu\u00f2 essere vuoto. Si prega di compilare il nome utente/e-mail e quindi premere il pulsante \"Invalidate Certificate\".",
    ...
    "Teaching Assistant": "Assistente all'istruzione",
    ...
    "These settings include basic information about your account.": "Questi campi includono informazioni personali relative al tuo account",
    ...
    "This comment could not be deleted. Refresh the page and try again.": "Non \u00e8 stato possibile cancellare questa risposta. Aggiorna la pagina e riprova.",
    ...
    "This response could not be marked as an answer. Refresh the page and try again.": "Non \u00e8 stato possibile contrassegnare questa immissione come risposta. Rinfresca la pagina e riprova.",
    ...
    "This response could not be unmarked as an answer. Refresh the page and try again.": "Non \u00e8 stato possibile annullare la contrassegnazione come risposta di questa immissione. Rinfresca la pagina e riprova.",
    ...
    "Unpublished changes to live content": "Aggiunte ai contenuti live non pubblicate",
    ...
    "While our support team is happy to assist with the edX platform, the course staff has the expertise for specific assignment questions, grading or the proper procedures in each course. Please post all course related questions within the Discussion Forum where the Course Staff can directly respond.": "Sebbene il nostro team di supporto sia lieto di assistere con la piattaforma edX, lo staff del corso ha l'esperienza necessaria per rispondere a domande sull'esercizio, valutazioni o procedure appropriate in ogni corso. Pubblica tutte le domande relative al corso all'interno del forum di discussione dove lo staff del corso potr\u00e0 rispondere direttamente. ",
    ...
    "You could not be subscribed to this post. Refresh the page and try again.": "Non \u00e8 stato possibile iscriverti a questo post. Rinfresca la pagina e riprova.",
    "You could not be unsubscribed from this post. Refresh the page and try again.": "Non \u00e8 stato possibile annullare l'iscrizione a questo post. Rinfresca la pagina e riprova.",
    ...
    "Your request could not be processed. Refresh the page and try again.": "Non \u00e8 stato possibile elaborare la tua richiesta. Ricarica la pagina e riprova.",
    ...
    "{htmlStart}Want to change your email, name, or password instead?{htmlEnd}": "{htmlStart}Vuoi forse cambiare invece la tua email, il nome utente, o la password?{htmlEnd}",
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on {platformName}.{strongEnd}": "{strongStart}Avvertenza: L'eliminazione dell'account \u00e8 definitiva.{strongEnd} Prima di procedere leggi attentamente quanto sopra. Questa \u00e8 un'azione irreversibile e {strongStart}non sarai pi\u00f9 in grado di utilizzare la stessa email sul sito https://acceleraconamazon.it/{strongEnd}",
    "{team_count} Team": [
      "{team_count} Squadra",
      "{team_count} Squadre",
      "{team_count} Squadre"
