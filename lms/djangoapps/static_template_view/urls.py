...
urlpatterns = [
    ...
    url(r'^cgu$', views.render, {'template': 'cgu.html'}, name="cgu"),
    url(r'^donnees$', views.render, {'template': 'donnees.html'}, name="donnees"),
    url(r'^legales$', views.render, {'template': 'legales.html'}, name="legales"),
