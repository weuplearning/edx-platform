...
def _reserve_task(course_id, task_type, task_key, task_input, requester, microsite):
    """
...
def submit_task(request, task_type, task_class, course_key, task_input, task_key, microsite):
    ...
    with outer_atomic():
        ...
        instructor_task = _reserve_task(course_key, task_type, task_key, task_input, request.user,microsite)
