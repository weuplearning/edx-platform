...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Subscription trial expires in {remainingDays} day": [
      "A avalia\u00e7\u00e3o da assinatura expira em <span class='notranslate'>{remainingDays}</span> dia",
      "A avalia\u00e7\u00e3o da assinatura expira em <span class='notranslate'>{remainingDays}</span> dias",
      "A avalia\u00e7\u00e3o da assinatura expira em <span class='notranslate'>{remainingDays}</span> dias"
    ],
    "Subsection": "Subse\u00e7\u00e3o",
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "Sua avalia\u00e7\u00e3o de {programName} expirar\u00e1 em {remainingDays} dia \u00e0s {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado <span class='notranslate'>{subscriptionPrice}</span> .",
      "Sua avalia\u00e7\u00e3o de {programName} expirar\u00e1 em {remainingDays} dias \u00e0s {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado <span class='notranslate'>{subscriptionPrice}</span> .",
      "Sua avalia\u00e7\u00e3o de {programName} expirar\u00e1 em {remainingDays} dias \u00e0s {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado <span class='notranslate'>{subscriptionPrice}</span> ."
    ],
