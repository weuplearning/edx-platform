        ...
        $.when(get,grade, advanced).done(function(results1,results2,result3) {
          ...
          $('.action-save').click(function(){
            ...
            $.ajax({
              ...
              success: function(retour) {
                /* update date */
                var start_date = retour.start_date;
                var end_date = retour.end_date;
                data.update_date_return('#add_course_start',start_date);
                data.update_date_return('#add_course_end',end_date);
